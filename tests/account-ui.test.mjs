...
assert.match(account, /supabase-provider\.js\?v=20260911-ledger-library2/);
assert.match(sharing, /supabase-provider\.js\?v=20260911-ledger-library2/);
assert.match(app, /sharing\.js\?v=20260911-ledger-library2/);
assert.match(app, /account\.js\?v=20260911-ledger-library2/);
assert.match(app, /system-admin\.js\?v=20260911-ledger-library2/);
assert.match(html, /app\.js\?v=20260911-ledger-library2/);
