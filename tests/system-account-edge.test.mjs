...
assert.match(edge, /getVerifiedInvitationUser/);
assert.match(edge, /user_metadata\?\.aoalb_invitation_operation_id/);
assert.match(edge, /automaticallyRecoverable: row\.status !== "manual_review" && Boolean\(verifiedUser\)/);
